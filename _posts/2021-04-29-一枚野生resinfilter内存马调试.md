...
文章首发于安全客[https://www.anquanke.com/post/id/239866](https://www.anquanke.com/post/id/239866)


## java 反编译工具

[cfr](http://www.benf.org/other/cfr/) CFR will decompile modern Java features - up to and including much of Java 9, 12 & 14, but is written entirely in Java 6, so will work anywhere! (FAQ) - It'll even make a decent go of turning class files from other JVM languages back into java!

* 反编译单个class java -jar cfr_0_129.jar evail_java_raw2.class > cft_decompile_evil2.java
* 反编译整个jar 包  --outputdir /tmp/putithere

[procyon]()
地址已经失效
https://github.com/deathmarine/Luyten/releases  基于 Procyon 0.5.33 开发的
...
和其他 `filter` 型内存马类似，创建 `filter`，添加 `filterConfigImpl` 实例，添加`filterMapping` 路由映射
...
![13.png](/img/resin_mem_shell/13.png)
...
![17.png](/img/resin_mem_shell/17.png)
![18.png](/img/resin_mem_shell/18.png)
